...
class Net(nn.Module):
    ...
    def __init__(self, factor = 0.5, n_mito_input_layer=100, n_cancer_types=4, n_latent_vector=2):
...
csv_files=[]
datasets=['LUSC', 'LUAD', 'MESO', 'HNSC', 'BRCA', 'PRAD', 'SKCM', 'UVM', 'KIRP', 'KICH', 'KIRC', 'GBM', 'LGG', 'STAD', 'PAAD']
