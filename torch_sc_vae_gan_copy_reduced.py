...
torch_dataset=torch_dataset_sc.SingleCellDataset(dataset_names=torch_dataset_sc.DATASETS, meta_groups_files=torch_dataset_sc.META_GROUPS, metagroups_names=["{}_{}".format(x, i_x) for i_x, x in enumerate(torch_dataset_sc.DATASETS)])
