import utils.add_GO_terms_metadata_extended
import pandas as pd
import numpy as np
import os
import constants

datasets=["TNFa_2","HC12", "SHERA", "ROR_1", "SHEZH_1"] # , "IEM" , "IES", "ROR_2", "SHEZH_1", "SHEZH_2", "ERS_1", "ERS_2"] # "SOC"
...
for cur_ds in datasets:
    for cur_alg in algos:
        results=utils.add_GO_terms_metadata_extended.main(cur_ds, cur_alg)
        if results is None:
            continue
